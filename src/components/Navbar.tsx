    ...
    <header className={styles.header}>
      <div className={styles.topBar}>
        <div className={`container ${styles.topBarContent}`}>
          <div className={styles.contactInfo}>
            ...
            <a href={waLink()} target="_blank" rel="noopener noreferrer" className={styles.topLink}>
      ...
      <div className={`container ${styles.nav}`}>
        ...
        <nav className={`${styles.navLinks} ${isOpen ? styles.open : ""}`}>
          <Link href="/" className={isActive("/") ? styles.activeHome : ""}>HOME</Link>
          ...
          <div className={styles.navItem}>
            ...
            <div className={styles.dropdown}>
              ...
              <Link href="/bikes/pit-bikes">PIT BIKES</Link>
              <Link href="/bikes/quads">QUADS</Link>
              <Link href="/bikes/utility">UTILITY</Link>
              <Link href="/bikes/electric">ELECTRIC</Link>
            </div>
          </div>

          <Link href="/services" className={isActive("/services") ? styles.activeHome : ""}>SERVICES</Link>
          <Link href="/parts" className={isActive("/parts") ? styles.activeHome : ""}>PARTS</Link>
          <Link href="/about" className={isActive("/about") ? styles.activeHome : ""}>ABOUT</Link>
          <Link href="/contact" className={isActive("/contact") ? styles.activeHome : ""}>CONTACT</Link>
        </nav>
      </div>
    </header>
  );
